...
tooling is not listed; it is not distributed. Rust rows come from `cargo metadata`, walking
...
15 packages, production dependencies only. Licenses in use: (MPL-2.0 OR Apache-2.0) · Apache-2.0 OR MIT · ISC · MIT · MIT OR Apache-2.0.
...
| libgit2-sys | 0.18.8+1.9.7 | MIT OR Apache-2.0 |
