...
export const session = {
  ...
  'session.roleNew': '새 판',
  'session.roleRetry': '다시 찍기',
  'session.rolePrereq': '아래층',
  'session.roleManual': '이 판 찍기',
  'session.roleGap': '판 만들기',
  ...
  'session.grade': '채점하기',
  'session.leave': '나가기',
  'session.dunnoReprint': '모르겠어요 · 다시 찍기',
  'session.dunnoPeek': '모르겠어요 · 원본 잠깐 보기',
  'session.hintNextPlate': '<b>Space</b> 로 다음 판',
  ...
  'plate.idleNote':
    '판정란 — 답을 고르고 Enter 를 누르면 맞았는지, 왜 그런지, 잉크가 몇 겹 오르는지가 여기 적힙니다.',
  'plate.linkPara': '이어보기',
  'plate.linkNew': '새로 열림',
  'plate.linkHeading': '↩ 방금 배운 것과 이어보기',
  'plate.crumbBack': '↩ 지금 위로 돌아가기',
  'plate.crumbPrereqNote': '1문제만 보고 같이 올라갑니다.',
  'plate.crumbReprintNote': '지난번에 어긋난 판입니다. 진단은 그대로 두고 <b>다시 고릅니다</b>.',
  'plate.layerN': '{{n}}겹',
  'plate.layerPlus': '+{{n}}겹',
  'plate.layerMinus': '−{{n}}겹',
  'plate.railVertical': '{{no}} · {{n}}겹 · {{name}}',
  'plate.inkLabel': '{{track}} · 잉크 {{n}}겹',
  ...
  'band.minutes': '{{n}}분',
  'band.today': '오늘 {{time}}',
  'band.left': '남은 시간 약 {{n}}분 · {{time}} 판',

  // ───────── 다시 찍기 사다리 ─────────
  'ladder.label': '다시 찍기 사다리',
  'ladder.heading': '모르겠어요 = 다시 찍기',
  'ladder.note':
    '흐리게 찍힌 판을 다시 거는 건 실패가 아니라 <b>공정</b>입니다. 부끄러운 일이 아니라 그 자리로 다시 데려다 달라는 신호예요.',
  'ladder.ink': '잉크',
  'ladder.today': '오늘 안에',
  'ladder.tabs': '다시 찍기 4단',
  'ladder.rungNo': '{{n}}단',
  'ladder.rung1': '더 자세히',
  'ladder.rung1Sub': '사전 3층 — 한 줄로 · 왜 필요한가 · 이 줄 안에서',
  'ladder.rung2': '여전히 모르겠어요',
  'ladder.rung2Sub': '아래층이 비어 있는지 진단하고, 비었으면 그 판으로 내려갑니다',
  'ladder.rung3': '다른 예시로',
  ...
  'prereq.allPrinted':
    '이 개념의 아래층은 모두 찍혀 있습니다. 이건 「이해 못 한」 것이 아니라 아직 익숙하지 않은 것입니다. 설명을 더 읽기보다 3단으로 내려가 같은 문법이 쓰인 내 코드를 여러 개 보는 편이 빠릅니다.',
  'prereq.someEmpty':
    '「모르겠어요」의 대부분은 이 개념이 어려워서가 아니라 아래층이 비어 있어서입니다. 이 개념을 떠받치는 {{n}}개 중 {{gaps}}개가 아직 안 찍혔습니다.',
  'prereq.justFilled':
    '비어 있던 층을 방금 채웠습니다. 아래층이 다 찼으니 위 「이어보기」 문단을 한 번 더 읽고 다시 짚어 보세요.',
  'prereq.justSeen': '방금 봄 · {{n}}겹',
  ...
  'summary.line': '{{printed}}판을 걸었고 {{mins}}분 걸렸습니다. 이 정도가 딱 좋습니다.',
  'summary.tallyPrinted': '찍은 판',
  'summary.tallyTime': '걸린 시간',
  'summary.tallyStreak': '연속 인쇄',
  'summary.unitPlate': '판',
  'summary.unitMinute': '분',
  'summary.unitDay': '일',
  'summary.inkMoved': '오늘 움직인 잉크',
  'summary.inkNote': '%가 아니라 겹으로 셉니다. 겹은 시간을 두고 다시 맞힐 때만 쌓입니다.',
  'summary.layerMinusReprint': '−{{n}}겹 · 다시 찍기',
  'summary.layerSame': '제자리',
  'summary.nextPrint': '다음 인쇄',
  'summary.liferHeading': '처음 기록한 문법 —',
  'summary.liferWhere': '#{{serial}} · 당신의 <b>{{file}}:{{line}}</b> 에서 채집',
  'summary.streakNote':
    '연속 <b>{{n}}일</b>. 연속 기록은 진도를 열지 않습니다 — 진도는 잉크 겹으로만 열립니다. 하루 쉬어도 다음 날 이어집니다.',
  'summary.tomorrow': '내일은 <b>{{n}}</b> 개념이 다시 올라옵니다.',
  'summary.again': '오늘 판 다시 보기',
  ...
  'clone.scoreNote':
    '이 중 글자까지 같은 줄은 <b>{{exact}}줄</b>. <b>동등</b>은 형태만 다르고 같은 뜻으로 인정한 줄 — 공백·들여쓰기, 따옴표 종류, 세미콜론, 주석 문구, 지역 변수명 일관 치환.',
  ...
  'clone.filterNotExact': '어긋남 + 동등만',
  'clone.filterAll': '전체',
  'clone.filterDiffer': '어긋남만',
  'clone.appealNote':
